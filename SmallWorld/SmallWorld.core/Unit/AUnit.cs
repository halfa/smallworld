...
namespace SmallWorld.Core
{
    ...
    public abstract class AUnit
    {
        ...
        /// <summary>
        /// Deetermines if the current unit can cross the specified tile, only regarding its type.
        /// </summary>
        ...
        /// <summary>
        /// Computes the number of points that the current unit might provide to its player owner.
        ...
        /// <summary>
        /// Updates the current unit's health points, lowering them by the specified amount.
